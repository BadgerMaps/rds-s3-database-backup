...
pg_dump ON_ERROR_STOP=1 --clean -Fc -Z 9 --no-acl --no-owner --quote-all-identifiers -v -h ${DATABASE_HOST} -U ${DATABASE_USER} -d ${DATABASE_NAME} --schema=public | aws s3 cp - ${TARGET}
rc=$?
